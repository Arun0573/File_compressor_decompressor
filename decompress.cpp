...
int main() {
    ...
    CharCode* charCodeArr = (CharCode*) malloc(sizeof(CharCode)*numOfUniqueChars);
    flag = 0;
    ...
    char* binaryString = (char*) malloc(binaryStringCapacity);
    binaryString[0] = '\0';
    char* tempBinary;
    ...
    while (fread(buff, 1, 1, input)) {
        ...
        if (binaryStringLength + tempBinaryLength + 1 > binaryStringCapacity) {
            ...
            binaryString = (char*) realloc(binaryString, binaryStringCapacity);
